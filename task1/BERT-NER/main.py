...
if __name__ == '__main__':
    ...
    parser.add_argument('--logging_steps', type=int, default=770, help="Log every X updates steps.")
    parser.add_argument('--save_steps', type=int, default=770, help="Save checkpoint every X updates steps.")
