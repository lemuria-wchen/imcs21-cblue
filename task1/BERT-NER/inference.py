...
def convert_input_file_to_tensor_dataset(lines,
    ...
    lines = [line[: 510] for line in lines]
...
def predict(pred_config):
    ...
    lines = read_input_file(os.path.join(pred_config.test_input_file))
    ...
    with open(pred_config.test_output_file, 'wb') as f:
        pickle.dump(seq_preds_list, f)
    # np.save(pred_config.test_output_file, np.array(seq_preds_list))
